function BookCard ({book, onFavourite, onAddToCart, onRemoveFavourite, showRemove = false,
    draggable = true, isFavourited = false}) {
        ...
        return (
            ...
            <div className="book-info">
                ...
                <div className="book-meta">Published: {book.publication_year}</div>
                ...
                {showRemove ? (
                    ...
                    <button 
                    className={`btn ${isFavourited ? 'btn-disabled'
                        : 'btn-primary'}`}
                    onClick={() => 
                        !isFavourited && onFavourite(book)}
